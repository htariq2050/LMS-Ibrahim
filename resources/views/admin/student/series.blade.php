            ...
            @foreach ($courses as $course)
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card card__course card__course__animate">
                        <a href="{{ route('checkout', $course->id) }}" class="card-img-top">
                            <img src="{{ asset('uploads/courses_cover_images/' . $course->cover_image) }}" class="card-img-top"
                                alt="Course image" style="border-radius: 10px;">
                            <span class="play-button">
                                <svg version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 50 50" width="60"
                                    height="60">
                        ...
                        <div class="p-3 text-center border-bottom">
                            <div class="bold mb-2">
                                <a href="student-course.html" class="text-body">
                                    <span class="course__title>">{{ $course->title }}</span>-<span class="course__subtitle">{{ $course->subtitle ?? 'No subtitle' }}</span>
                                </a>
                            </div>
                                ...
                                <div class="mb-2 text-muted d-flex align-items-center align-self-center">
                                    <small class="mr-3 d-flex align-items-center">
                                        <svg version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink"
                                            viewBox="0 0 40 40" width="18" height="18">
                        ...
                        <div class="p-3 text-center">
                            ...
                            <strong class="h4 m-0 text-primary">${{ $course->price }}</strong>
